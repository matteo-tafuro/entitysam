...
class SAM2QueryIoUBase(torch.nn.Module):
    def __init__(
        self,
        image_encoder,
        memory_attention,
    ...
    def _forward_sam_heads(
        ...
        (
            ...
            image_embeddings=backbone_features_seg,
    ...
    def _use_mask_as_output(self, backbone_features, high_res_features, mask_inputs):
        ...
        cls_logits_pred = mask_inputs.new_ones(mask_inputs.size(0), 2).float()
    ...
    def track_step(
        ...
        current_out["iou_pred"] = iou_pred
        current_out["cls_logits_pred"] = cls_logits_pred
