...
class SAM2CameraQueryIoUPredictor(SAM2QueryIoUBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.training:
            from train import VideoHungarianMatcherUniClsag, VideoSetCriterionClsagIoU
            from train.prepare_targets import PrepareTargets
    ...
    def reset_state_train(self, inference_state):
        """Remove all input points or mask in all frames throughout the video."""
        self._reset_tracking_results(inference_state)
        # Remove all object ids
        inference_state["obj_id_to_idx"].clear()
